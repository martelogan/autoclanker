...
| Bottom `slice:<name>` filters include descendant-attribute rescue behavior | covered | `test_clankerprof_slice_filter_honors_descendant_attribute_slice_matches`, `test_clankerprof_rust_round5_cluster_p_matches_python`, Rust `bottom_slice_filters_honor_descendant_attribute_rescue` |
